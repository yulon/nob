...
namespace nob {
	namespace ntv {
		namespace AUDIO {
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, bool toggle)> SET_SIREN_WITH_NO_DRIVER;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, const char* audioName)> _SET_VEHICLE_AUDIO;
			...
			extern typed_lazy_func_t<void(int soundId, Any* p1, float p2)> SET_VARIABLE_ON_SOUND;
			...
			extern typed_lazy_func_t<void(Any* p0, bool p1, bool p2)> SET_AMBIENT_ZONE_LIST_STATE;
		...
		namespace WEAPON {
			...
			extern typed_lazy_func_t<bool(Hash weaponHash, int* outData)> GET_WEAPON_HUD_STATS;
		...
		namespace STREAMING {
			...
			extern typed_lazy_func_t<void(const char* fxName)> REQUEST_NAMED_PTFX_ASSET;
			...
			extern typed_lazy_func_t<bool(const char* fxName)> HAS_NAMED_PTFX_ASSET_LOADED;
			...
			extern typed_lazy_func_t<Any()> NETWORK_UPDATE_LOAD_SCENE;
			extern typed_lazy_func_t<void(const char* fxName)> _REMOVE_NAMED_PTFX_ASSET;
			...
			extern typed_lazy_func_t<void()> _0xB5A4DB34FE89B88A;
		} /* STREAMING */
		namespace APP {
			...
			extern typed_lazy_func_t<bool()> APP_DATA_VALID;
			...
			extern typed_lazy_func_t<int(const char* property)> APP_GET_INT;
		...
		namespace PATHFIND {
			...
			extern typed_lazy_func_t<int(float x, float y, float z, bool p3, float* direction, float* p5, float* distToNxJunction)> GENERATE_DIRECTIONS_TO_COORD;
		...
		namespace PED {
			...
			extern typed_lazy_func_t<void(Any p0)> _0xA21C118553BBDF02;
			...
			extern typed_lazy_func_t<bool(Any p0, Any p1)> HAS_PED_RECEIVED_EVENT;
			...
			extern typed_lazy_func_t<int(Ped ped)> _GET_PED_TIME_OF_DEATH;
			...
			extern typed_lazy_func_t<void(Any p0)> _0xED3C76ADFA6D07C4;
			...
			extern typed_lazy_func_t<Any(Ped ped, int p1, int drawableId, int textureId)> _0x39D55A620FCB6A3A;
			...
			extern typed_lazy_func_t<Ped(int pedType, Hash modelHash, float x, float y, float z, float heading, bool isNetwork, bool p7)> CREATE_PED;
			...
			extern typed_lazy_func_t<void(Ped ped, Any p1, Any p2, float p3, float p4)> SET_PED_BLEND_FROM_PARENTS;
			...
			extern typed_lazy_func_t<Any(Any p0)> _0x451294E859ECC018;
			...
			extern typed_lazy_func_t<Ped(Ped ped, float heading, bool isNetwork, bool p3)> CLONE_PED;
			...
			extern typed_lazy_func_t<Any(Ped ped, bool pinned, int i)> SET_PED_PINNED_DOWN;
			...
			extern typed_lazy_func_t<Ped(Vehicle vehicle, int pedType, Hash modelHash, int seat, bool isNetwork, bool p5)> CREATE_PED_INSIDE_VEHICLE;
			...
			extern typed_lazy_func_t<void(Ped ped, int p1, Ped targetPed, int boneLookAt, float x, float y, float z, Any p7, int duration, int duration1)> SET_IK_TARGET;
			...
			extern typed_lazy_func_t<Any(Any p0, Any p1, Any p2)> _0xC56FBF2F228E1DAC;
		...
		namespace VEHICLE {
			...
			extern typed_lazy_func_t<void(Any p0, float p1)> _0x30D779DE7C4F6DD3;
			extern typed_lazy_func_t<void(Vehicle vehicle, bool p1)> _0xAB04325045427AAE;
			extern typed_lazy_func_t<void(Vehicle vehicle, bool p1)> SET_VEHICLE_EXCLUSIVE_DRIVER;
			...
			extern typed_lazy_func_t<Vehicle(Object object)> _GET_VEHICLE_ATTACHED_TO_ENTITY;
			extern typed_lazy_func_t<void(int i, const char* name)> REQUEST_VEHICLE_RECORDING;
			extern typed_lazy_func_t<void(Any vehicleGenerator, bool enabled)> SET_SCRIPT_VEHICLE_GENERATOR;
			extern typed_lazy_func_t<bool(Any p0)> _0x1033371FC8E842A7;
			...
			extern typed_lazy_func_t<float(Hash modelHash)> _0x53409B5163D5B846;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, int vehicleComponent, int destroyType)> SET_PED_TARGETTABLE_VEHICLE_DESTROY;
			...
			extern typed_lazy_func_t<Any(float p0, float p1, float p2, float p3, float p4, bool p5)> _0x2CE544C68FB812A0;
			...
			extern typed_lazy_func_t<float(Hash modelHash)> _0xC6AD107DDC9054CC;
			...
			extern typed_lazy_func_t<bool(int vehicleGenerator)> DOES_SCRIPT_VEHICLE_GENERATOR_EXIST;
			...
			extern typed_lazy_func_t<void()> _0xEF49CF0270307CBE;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, bool p1)> _0x8F719973E1445BA2;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle)> _0x7C0043FDFF6436BC;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, bool p1)> _0xCAC66558B944DA67;
			...
			extern typed_lazy_func_t<bool(Vehicle vehicle, int wheelID, bool completely)> IS_VEHICLE_TYRE_BURST;
			...
			extern typed_lazy_func_t<float(Hash modelHash)> _0xBFBA3BA79CFF7EBF;
			...
			extern typed_lazy_func_t<void(Any p0, float p1)> _0x9AA47FFF660CB932;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, bool toggle)> _SET_VEHICLE_SUKA;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, int livery)> SET_VEHICLE_LIVERY;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, int* paintType, int* color, int* p3)> GET_VEHICLE_MOD_COLOR_1;
			...
			extern typed_lazy_func_t<void(bool toggle)> _0xD4B8E3D1917BC86B;
			extern typed_lazy_func_t<void(Vehicle train, float x, float y, float z)> SET_MISSION_TRAIN_COORDS;
			extern typed_lazy_func_t<int(Vehicle vehicle)> GET_VEHICLE_LIVERY;
			extern typed_lazy_func_t<float(Hash modelHash)> _0x5AA3F878A178C4FC;
			...
			extern typed_lazy_func_t<void(Vehicle plane, int height)> _SET_PLANE_MIN_HEIGHT_ABOVE_GROUND;
			...
			extern typed_lazy_func_t<int(Vehicle vehicle)> GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX;
			...
			extern typed_lazy_func_t<void(Any p0, float p1)> _0xCF1182F682F65307;
			...
			extern typed_lazy_func_t<void(Any p0, bool p1)> _0x06582AFF74894C75;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, int doorIndex, bool p2, bool p3, bool p4)> SET_VEHICLE_DOOR_LATCHED;
			...
			extern typed_lazy_func_t<Vehicle(Hash modelHash, float x, float y, float z, float heading, bool isNetwork, bool p6)> CREATE_VEHICLE;
		...
		namespace WATER {
			...
			extern typed_lazy_func_t<int(float x, float y, float z, float radius, float unk)> _ADD_CURRENT_RISE;
			...
			extern typed_lazy_func_t<bool(float x, float y, float z, Any p3, Any* p4)> TEST_VERTICAL_PROBE_AGAINST_ALL_WATER;
		...
		namespace WORLDPROBE {
			...
			extern typed_lazy_func_t<int(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity entity, int p8)> START_SHAPE_TEST_LOS_PROBE;
		...
		namespace GAMEPLAY {
			...
			extern typed_lazy_func_t<void(bool p0)> SET_RANDOM_EVENT_FLAG;
			...
			extern typed_lazy_func_t<void(float x1, float y1, float z1, float x2, float y2, float z2, int damage, bool p7, Hash weaponHash, Ped ownerPed, bool isAudible, bool isInvisible, float speed, Entity entity)> _SHOOT_SINGLE_VEHICLE_BULLET_BETWEEN_COORDS;
			...
			extern typed_lazy_func_t<Any(Ped ped, Hash weaponhash, float p2, float p3, float p4, bool p5)> _0x82FDE6A57EE4EE44;
			...
			extern typed_lazy_func_t<void(float x1, float y1, float z1, float x2, float y2, float z2, int damage, bool p7, Hash weaponHash, Ped ownerPed, bool isAudible, bool isInvisible, float speed, Entity entity, bool p14, bool p15, bool p16, bool p17)> _SHOOT_SINGLE_AIRSTRIKE_BULLET_BETWEEN_COORDS;
			...
			extern typed_lazy_func_t<Any()> _0xD3D15555431AB793;
			...
			extern typed_lazy_func_t<Any()> _0x996DD1E1E02F1008;
			...
			extern typed_lazy_func_t<Any(Player player)> SET_EXPLOSIVE_AMMO_THIS_FRAME;
			...
			extern typed_lazy_func_t<bool(Ped ped, Hash weaponHash, float radius, Entity* entity, bool p4)> _0xDFB4138EEFED7B81;
			...
			extern typed_lazy_func_t<Any(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8)> _0x8D7A43EC6A5FEA45;
			...
			extern typed_lazy_func_t<Any()> _0x6856EC3D35C81EA4;
			...
			extern typed_lazy_func_t<Any(bool p0)> _0xA09F896CE912481F;
			...
			extern typed_lazy_func_t<Any(Player player)> SET_SUPER_JUMP_THIS_FRAME;
			...
			extern typed_lazy_func_t<bool(float p0, float p1, float p2, Any p3, float p4, bool p5)> _0x34318593248C8FB2;
			...
			extern typed_lazy_func_t<void(Any p0, Any p1)> _0x4DCDF92BF64236CD;
			...
			extern typed_lazy_func_t<bool(Any* p0, Any* p1, Any p2, bool p3)> _0xB335F761606DB47C;
			...
			extern typed_lazy_func_t<void(float x, float y, float z, float radius, int flags)> CLEAR_AREA_OF_PROJECTILES;
		...
		namespace ITEMSET {
			...
			extern typed_lazy_func_t<Any(Vector3* distri)> CREATE_ITEMSET;
			...
			extern typed_lazy_func_t<Any(Any p0)> GET_ITEMSET_SIZE;
		...
		namespace CONTROLS {
			...
			extern typed_lazy_func_t<const char*(int inputGroup, int control, bool p2)> GET_CONTROL_INSTRUCTIONAL_BUTTON;
		...
		namespace NETWORK {
			...
			extern typed_lazy_func_t<void(Any p0, Any p1)> _0x3E200C2BCF4164EB;
			...
			extern typed_lazy_func_t<Any()> _0xDC48473142545431;
			...
			extern typed_lazy_func_t<Any()> _0x172F75B6EE2233BA;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle, bool toggle)> _SET_NETWORK_VEHICLE_NON_CONTACT;
			...
			extern typed_lazy_func_t<void(Any* globalPtr)> _0xABD5E88B8A2D3DB2;
			extern typed_lazy_func_t<bool(Any p0)> _0x5CAE833B0EE0C500;
			extern typed_lazy_func_t<bool()> NETWORK_IS_MULTIPLAYER_DISABLED;
			...
			extern typed_lazy_func_t<Any()> _0x422D396F80A96547;
			...
			extern typed_lazy_func_t<bool(Ped ped, Player player)> _0x99B72C7ABDE5C910;
			...
			extern typed_lazy_func_t<Any(Any p0, Any p1)> _0xBAF6BABF9E7CCC13;
			...
			extern typed_lazy_func_t<const char*(Player player, int* userID)> NETWORK_PLAYER_GET_USERID;
			...
			extern typed_lazy_func_t<bool()> _0x8D11E61A4ABF49CC;
			...
			extern typed_lazy_func_t<Any(Any p0)> NETWORK_IS_PENDING_FRIEND;
			...
			extern typed_lazy_func_t<bool(Hash tunbaleContext, Hash tunableName)> _NETWORK_DOES_TUNABLE_EXIST_HASH;
			extern typed_lazy_func_t<void()> _0x61A885D3F7CFEE9A;
			extern typed_lazy_func_t<Any()> _0xA75E2B6733DA5142;
			...
			extern typed_lazy_func_t<void(Any p0, Any p1, Any p2, Any p3)> NETWORK_SET_RICH_PRESENCE;
			...
			extern typed_lazy_func_t<void(int* vars, int numVars)> NETWORK_REGISTER_HOST_BROADCAST_VARIABLES;
			...
			extern typed_lazy_func_t<bool(Any p0)> _0x0AE1F1653B554AB9;
			...
			extern typed_lazy_func_t<bool(const char* scriptName, Any p1, bool p2, Any p3)> NETWORK_IS_SCRIPT_ACTIVE;
			...
			extern typed_lazy_func_t<bool(Any p0, Any* p1, Any* p2)> _0xC22912B1D85F26B1;
			...
			extern typed_lazy_func_t<Any()> _0x43865688AE10F0D7;
			...
			extern typed_lazy_func_t<bool(int netId)> _0xA1607996431332DF;
			...
			extern typed_lazy_func_t<Any()> _0x638A3A81733086DB;
			...
			extern typed_lazy_func_t<bool(Any* p0, Any p1, Any p2)> _0x098AB65B9ED9A9EC;
			...
			extern typed_lazy_func_t<Any()> NETWORK_IS_ADDING_FRIEND;
		...
		namespace UI {
			...
			extern typed_lazy_func_t<bool()> _IS_LOADING_PROMPT_BEING_DISPLAYED;
			...
			extern typed_lazy_func_t<float(int font)> _END_TEXT_COMMAND_GET_WIDTH;
			...
			extern typed_lazy_func_t<void(Any* p0, Any* p1, Any* p2)> _0x7E17BE53E1AAABAF;
			...
			extern typed_lazy_func_t<void(Hash interior, float x, float y, int z, int zoom)> SET_RADAR_AS_INTERIOR_THIS_FRAME;
			...
			extern typed_lazy_func_t<void(const char* entryHeader, const char* entryLine1, int instructionalKey, const char* entryLine2, bool p4, Any p5, Any* p6, Any* p7, bool background)> _SET_WARNING_MESSAGE_2;
			...
			extern typed_lazy_func_t<Any()> _0xB2A592B04648A9CB;
			...
			extern typed_lazy_func_t<void(const char* type)> _SET_NOTIFICATION_TEXT_ENTRY;
			...
			extern typed_lazy_func_t<void(int pedHandle, bool showViewCones)> _SET_PED_ENEMY_AI_BLIP;
			...
			extern typed_lazy_func_t<Any()> _0x01A358D9128B7A86;
			...
			extern typed_lazy_func_t<void(Ped ped, int unk)> _0xE52B8E7F85D39A08;
			...
			extern typed_lazy_func_t<int(float x, float y)> _END_TEXT_COMMAND_GET_LINE_COUNT;
			...
			extern typed_lazy_func_t<void(bool p0, Any* p1)> _0xE45087D85F468BC2;
			extern typed_lazy_func_t<Pickup(Blip blip)> GET_BLIP_INFO_ID_PICKUP_INDEX;
			extern typed_lazy_func_t<void(Ped ped, bool p1)> _0x0C4BBF625CA98C4E;
			...
			extern typed_lazy_func_t<void()> _0x0AFC4AF510774B47;
			...
			extern typed_lazy_func_t<void(float p0, float p1)> SET_ABILITY_BAR_VALUE;
			...
			extern typed_lazy_func_t<void(int busySpinnerType)> _SHOW_LOADING_PROMPT;
			...
			extern typed_lazy_func_t<int(const char* p0, int p1, int p2, int p3, bool p4, const char* picName1, const char* picName2)> _SET_NOTIFICATION_MESSAGE;
			...
			extern typed_lazy_func_t<void(const char* string)> _SET_LOADING_PROMPT_TEXT_ENTRY;
		...
		namespace GRAPHICS {
			...
			extern typed_lazy_func_t<void(int p0, const char* p1, bool p2)> _0xF7B38B8305F1FE8B;
			...
			extern typed_lazy_func_t<bool(Any* p0, Any p1, Any p2, Any p3)> _0x4862437A486F91B0;
			extern typed_lazy_func_t<Object()> CREATE_TRACKED_POINT;
			...
			extern typed_lazy_func_t<bool(int hudComponent, const char* functionName)> _PUSH_SCALEFORM_MOVIE_FUNCTION_FROM_HUD_COMPONENT;
			...
			extern typed_lazy_func_t<void(Object object)> _UPDATE_ENTITY_SHIT_OR_SOMETHING;
			...
			extern typed_lazy_func_t<bool(int decal)> IS_DECAL_ALIVE;
			extern typed_lazy_func_t<void()> _0x27CFB1B1E078CB2D;
			extern typed_lazy_func_t<void(bool value)> _PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL;
			...
			extern typed_lazy_func_t<void()> _POP_SCALEFORM_MOVIE_FUNCTION_VOID;
			...
			extern typed_lazy_func_t<Any(Any p0)> _0x2A893980E96B659A;
			...
			extern typed_lazy_func_t<void(float p0, float p1, Any* p2, Any* p3)> _0x6DD8F5AA635EB4B2;
			extern typed_lazy_func_t<bool(Object point)> IS_TRACKED_POINT_VISIBLE;
			extern typed_lazy_func_t<bool(const char* functionName)> _PUSH_SCALEFORM_MOVIE_FUNCTION_N;
			extern typed_lazy_func_t<void(int layer)> _SET_2D_LAYER;
			...
			extern typed_lazy_func_t<void(Any p0, Any* p1, Any* p2)> _0x8A35C742130C6080;
			...
			extern typed_lazy_func_t<const char*(int scaleform)> SITTING_TV;
			...
			extern typed_lazy_func_t<bool(Any funcData)> _0x768FF8961BA904D6;
			...
			extern typed_lazy_func_t<void(int value)> _PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT;
			...
			extern typed_lazy_func_t<void(int scaleform, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float p7, float p8, float p9, float scaleX, float scaleY, float scaleZ, Any p13)> DRAW_SCALEFORM_MOVIE_3D;
			...
			extern typed_lazy_func_t<Any()> _0x0D6CA79EEEBD8CA3;
			...
			extern typed_lazy_func_t<Any()> _0xA67C35C56EB1BD9D;
			extern typed_lazy_func_t<Any(Any p0)> _0xCB82A0BF0E3E3265;
			...
			extern typed_lazy_func_t<void(const char* value)> _PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_STRING;
			...
			extern typed_lazy_func_t<Any()> _0x0C0C4E81E1AC60A0;
			...
			extern typed_lazy_func_t<Any(Object point, float x, float y, float z, float radius)> SET_TRACKED_POINT_INFO;
			...
			extern typed_lazy_func_t<bool(Any p0)> _0x5E657EF1099EDD65;
			...
			extern typed_lazy_func_t<bool(int scaleform, const char* functionName)> _PUSH_SCALEFORM_MOVIE_FUNCTION;
			...
			extern typed_lazy_func_t<Any()> _0x5B0316762AFD4A64;
			...
			extern typed_lazy_func_t<void(float value)> _PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT;
			...
			extern typed_lazy_func_t<bool(Any p0)> _0x759650634F07B6B4;
			...
			extern typed_lazy_func_t<Any()> _0x90A78ECAA4E78453;
			extern typed_lazy_func_t<void(int* x, int* y)> GET_SCREEN_RESOLUTION;
			extern typed_lazy_func_t<void(Any p0)> _0xEC52C631A1831C03;
			extern typed_lazy_func_t<void(bool toggle)> SET_NOISEOVERIDE;
			extern typed_lazy_func_t<void(Any p0)> _0xB7ED70C49521A61D;
			...
			extern typed_lazy_func_t<Any()> _0xDC54A7AF8B3A14EF;
			extern typed_lazy_func_t<void(bool p0)> _0x6DDBF9DFFC4AC080;
			extern typed_lazy_func_t<int(Any funcData)> _0x2DE7EFA66B906036;
			extern typed_lazy_func_t<Any(Any p0)> _0xF5BED327CEA362B1;
			...
			extern typed_lazy_func_t<Any(int p0)> _0x3DEC726C25A11BAC;
			extern typed_lazy_func_t<int()> _0x473151EBC762C6DA;
			...
			extern typed_lazy_func_t<bool(const char* p0, Ped ped, int p2, float posX, float posY, float posZ)> _0x98C4FE6EC34154CA;
			...
			extern typed_lazy_func_t<bool(const char* functionName)> _0xB9449845F73F5E9C;
			extern typed_lazy_func_t<int()> _POP_SCALEFORM_MOVIE_FUNCTION;
			extern typed_lazy_func_t<void(bool p0)> _0x23BA6B0C2AD7B0D3;
			extern typed_lazy_func_t<Any()> _0x7FA5D82B8F58EC06;
			extern typed_lazy_func_t<void(int decal)> REMOVE_DECAL;
			extern typed_lazy_func_t<void(bool p0)> _0x02369D5C8A51FDCF;
			extern typed_lazy_func_t<void(const char* button)> _0xE83A3E3557A56640;
			...
			extern typed_lazy_func_t<void(Object point)> DESTROY_TRACKED_POINT;
			extern typed_lazy_func_t<void(float p0)> _0x99AC7F0D8B9C893D;
			extern typed_lazy_func_t<Any()> _0x1DD2139A9A20DCE8;
			...
			extern typed_lazy_func_t<int(int decalType, float posX, float posY, float posZ, float p4, float p5, float p6, float p7, float p8, float p9, float width, float height, float rCoef, float gCoef, float bCoef, float opacity, float timeout, bool p17, bool p18, bool p19)> ADD_DECAL;
		...
		namespace DATAFILE {
			...
			extern typed_lazy_func_t<void(Any p0)> _0xAD6875BBC0FC899C;
		...
		namespace ROPE {
			...
			extern typed_lazy_func_t<Any(Object rope, bool length)> ROPE_RESET_LENGTH;
			...
			extern typed_lazy_func_t<void(Object rope, Entity ent1, Entity ent2, float ent1_x, float ent1_y, float ent1_z, float ent2_x, float ent2_y, float ent2_z, float length, bool p10, bool p11, Any* p12, Any* p13)> ATTACH_ENTITIES_TO_ROPE;
		...
		namespace PLAYER {
			extern typed_lazy_func_t<bool(int achievement)> GIVE_ACHIEVEMENT_TO_PLAYER;
			...
			extern typed_lazy_func_t<bool(Any p0, Any p1)> _0xC2AFFFDABBDC2C5C;
			extern typed_lazy_func_t<float(Player player)> GET_WANTED_LEVEL_RADIUS;
			...
			extern typed_lazy_func_t<void(Player player, float amount, int gaitType, float speed, bool p4, bool p5)> SIMULATE_PLAYER_INPUT_GAIT;
			...
			extern typed_lazy_func_t<void(Player player, float modifier)> SET_PLAYER_WEAPON_DEFENSE_MODIFIER;
			extern typed_lazy_func_t<void(Player player, int tintIndex)> SET_PLAYER_PARACHUTE_TINT_INDEX;
			extern typed_lazy_func_t<Ped(Player player)> GET_PLAYER_PED;
			...
			extern typed_lazy_func_t<void(Player player, Vector3* position, bool p2, bool p3)> SET_PLAYER_WANTED_CENTRE_POSITION;
			...
			extern typed_lazy_func_t<bool(Any p0)> _0x690A61A6D13583F6;
			...
			extern typed_lazy_func_t<Cam(Any p0)> _0x1C186837D0619335;
			...
			extern typed_lazy_func_t<void(Any p0)> _0x5501B7A5CDB79D37;
			...
			extern typed_lazy_func_t<int()> GET_NUMBER_OF_PLAYERS;
			...
			extern typed_lazy_func_t<void(Player player, bool toggle, int possiblyFlags)> SET_PLAYER_CONTROL;
			...
			extern typed_lazy_func_t<void(Any p0)> _0x5702B917B99DB1CD;
			...
			extern typed_lazy_func_t<Any()> _0xB9CF1F793A9F1BF1;
		...
		namespace OBJECT {
			...
			extern typed_lazy_func_t<Object(Hash modelHash, float x, float y, float z, bool isNetwork, bool p5, bool dynamic)> CREATE_OBJECT_NO_OFFSET;
			...
			extern typed_lazy_func_t<Object(Object modelHash, float x, float y, float z, bool isNetwork, bool spawnCheck, bool dynamic)> CREATE_OBJECT;
			...
			extern typed_lazy_func_t<Pickup(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, Hash modelHash, bool p7, bool p8)> CREATE_AMBIENT_PICKUP;
			extern typed_lazy_func_t<void(Any p0, int p1)> _0x0BF3B3BD47D79C08;
			...
			extern typed_lazy_func_t<void(Any p0, Any p1)> SET_PICKUP_REGENERATION_TIME;
		...
		namespace CUTSCENE {
			...
			extern typed_lazy_func_t<Any()> _0x5EDEF0CF8C1DAB3C;
		...
		namespace CAM {
			...
			extern typed_lazy_func_t<float()> _0xA03502FC581F7D9B;
			...
			extern typed_lazy_func_t<void(float p0, float p1)> _0xBCFC632DB7673BF0;
			extern typed_lazy_func_t<void(bool p0)> _0x4008EDF7D6E48175;
			extern typed_lazy_func_t<float()> _0x9780F32BCAF72431;
			...
			extern typed_lazy_func_t<float()> _0xDFC8CBC606FDB0FC;
			...
			extern typed_lazy_func_t<void(float p0)> _0x42156508606DE65E;
			...
			extern typed_lazy_func_t<Any(float x, float Value2)> SET_GAMEPLAY_CAM_RELATIVE_PITCH;
			...
			extern typed_lazy_func_t<void(float p0)> _0x0AF7B437918103B3;
			...
			extern typed_lazy_func_t<Cam(const char* camName, bool p1)> CREATE_CAM;
		...
		namespace SCRIPT {
			extern typed_lazy_func_t<void(bool p0, int* args, int argCount, int bit)> TRIGGER_SCRIPT_EVENT;
			...
			extern typed_lazy_func_t<int(bool p0, int eventNum)> GET_EVENT_AT_INDEX;
			extern typed_lazy_func_t<bool(bool p0, int eventNum, int* argStruct, int argStructSize)> GET_EVENT_DATA;
		...
		namespace MOBILE {
			...
			extern typed_lazy_func_t<void(Vector3* rotation, Any p1)> GET_MOBILE_PHONE_ROTATION;
			...
			extern typed_lazy_func_t<void(int phoneType)> CREATE_MOBILE_PHONE;
		...
		namespace NETWORKCASH {
			...
			extern typed_lazy_func_t<bool(Any p0)> _0x6FCF8DDEA146C45B;
		...
		namespace DLC1 {
			...
			extern typed_lazy_func_t<bool(int dlcData)> _IS_DLC_DATA_EMPTY;
			extern typed_lazy_func_t<bool(int modData)> IS_DLC_VEHICLE_MOD;
			...
			extern typed_lazy_func_t<bool(int dlcWeaponIndex, int dlcWeapCompIndex, int* ComponentDataPtr)> GET_DLC_WEAPON_COMPONENT_DATA;
		...
		namespace ENTITY {
			...
			extern typed_lazy_func_t<void(Entity entity, int alphaLevel, bool skin)> SET_ENTITY_ALPHA;
			...
			extern typed_lazy_func_t<Vector3(Hash entity)> GET_ENTITY_FORWARD_VECTOR;
			...
			extern typed_lazy_func_t<bool(Entity entity)> DOES_ENTITY_EXIST;
		...
		namespace UNK3 {
			...
			extern typed_lazy_func_t<bool(Any p0)> _NETWORK_SHOP_END_SERVICE;
			...
			extern typed_lazy_func_t<bool(int* value, Any p1, Any p2, Any p3, Any p4, int p5)> _NETWORK_SHOP_BEGIN_SERVICE;
			...
			extern typed_lazy_func_t<bool(Any p0)> _NETWORK_SHOP_CHECKOUT_START;
			...
			extern typed_lazy_func_t<bool(Any* p0, Any p1, Any p2, Any p3)> _NETWORK_SHOP_BASKET_START;
		...
		namespace UNK2 {
			...
			extern typed_lazy_func_t<void(Any p0, Any p1)> _0x7E2BD3EF6C205F09;
		...
		namespace STATS {
			...
			extern typed_lazy_func_t<void(Any p0, float p1)> _0x428EAF89E24F6C36;
			...
			extern typed_lazy_func_t<void(Any p0, Any p1, Any p2)> _0x11FF1C80276097ED;
		...
		namespace SOCIALCLUB {
			...
			extern typed_lazy_func_t<bool(const char* p0)> _0x6AFD2CD753FEEF83;
			extern typed_lazy_func_t<Any()> _0xBC1CC91205EC8D6E;
			extern typed_lazy_func_t<const char*()> _SC_GET_NICKNAME;
			...
			extern typed_lazy_func_t<void(int* p0)> _0xDA024BDBD600F44A;
		...
		namespace AI {
			...
			extern typed_lazy_func_t<Any(Ped ped, Any* p1, Any* p2)> GET_NAVMESH_ROUTE_DISTANCE_REMAINING;
			...
			extern typed_lazy_func_t<bool(Any p0, Any* p1)> _0xB4F47213DF45A64C;
			...
			extern typed_lazy_func_t<void(Ped ped, float x, float y, float z, float heading, float p5)> TASK_PED_SLIDE_TO_COORD;
			...
			extern typed_lazy_func_t<void(Ped p0, const char* p1, float p2)> _0xD5BB4025AE449A4E;
			...
			extern typed_lazy_func_t<void(Ped p0, Any* p1, bool p2)> _0xB0A6CFD2C69C1088;
			...
			extern typed_lazy_func_t<bool(Any p0, const char* p1)> _0xA7FFBA498E4AAF67;
			...
			extern typed_lazy_func_t<void(int p0, Ped oed, int duration, float p3, float p4, float p5, float p6, bool p7)> TASK_GOTO_ENTITY_OFFSET_XY;
