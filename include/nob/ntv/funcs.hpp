...
namespace nob {
	namespace ntv {
		...
		namespace UI {
			...
			extern typed_lazy_func_t<void(Blip blip, bool p1)> _0x75A16C3DA34F1245;
			...
			extern typed_lazy_func_t<void(Blip blip, bool toggle)> SHOW_TICK_ON_BLIP;
			...
			extern typed_lazy_func_t<int(bool blink, bool showInBrief)> _DRAW_NOTIFICATION;
			...
			extern typed_lazy_func_t<void(Any p0, bool loop, bool beep, int duration)> END_TEXT_COMMAND_DISPLAY_HELP;
		...
		namespace UNK3 {
			...
			extern typed_lazy_func_t<int(Hash itemHash, Hash hash2, bool p2)> _NETWORK_SHOP_GET_PRICE;
		...
		namespace GAMEPLAY {
			...
			extern typed_lazy_func_t<int(int threadId)> _GET_FREE_STACK_SLOTS_COUNT;
		...
		namespace WEAPON {
			...
			extern typed_lazy_func_t<void(Any ammoType, int ammo)> SET_PED_AMMO_TO_DROP;
		...
		namespace NETWORK {
			...
			extern typed_lazy_func_t<bool(Any* p0)> _NETWORK_CHECK_DATA_MANAGER_FOR_HANDLE;
			...
			extern typed_lazy_func_t<const char*(int p0)> GET_PLAYER_ADVANCED_MODIFIER_PRIVILEGES;
			...
			extern typed_lazy_func_t<bool()> NETWORK_SESSION_IS_VISIBLE;
			...
			extern typed_lazy_func_t<bool(Player* player, Any* p1)> _NETWORK_GET_PLAYER_CREW_EMBLEM_TXD_NAME;
		...
		namespace PED {
			...
			extern typed_lazy_func_t<void(Ped ped, int damageAmount, bool armorFirst)> APPLY_DAMAGE_TO_PED;
		...
		namespace AI {
			...
			extern typed_lazy_func_t<void(Ped driver, Vehicle vehicle, Entity targetEntity, float speed, int drivingStyle, int minDistance)> _TASK_VEHICLE_FOLLOW;
		...
		namespace VEHICLE {
			...
			extern typed_lazy_func_t<void(Vehicle cargobob, float xOffset, float yOffset, int state)> _SET_CARGOBOB_HOOK_POSITION;
			...
			extern typed_lazy_func_t<int(Vehicle vehicle)> GET_CURRENT_PLAYBACK_FOR_VEHICLE;
			...
			extern typed_lazy_func_t<void(Vehicle vehicle)> STOP_PLAYBACK_RECORDED_VEHICLE;
			...
			extern typed_lazy_func_t<Vehicle(Vehicle v, int rwing)> IS_VEHICLE_DOOR_FULLY_OPEN;
			...
			extern typed_lazy_func_t<bool(Vehicle vehicle)> IS_PLAYBACK_GOING_ON_FOR_VEHICLE;
			...
			extern typed_lazy_func_t<float(int recordingID)> GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID;
		...
		namespace PLAYER {
			...
			extern typed_lazy_func_t<void(Any toggle)> SET_POLICE_RADAR_BLIPS;
			...
			extern typed_lazy_func_t<Player(Vehicle player)> IS_PLAYER_FREE_FOR_AMBIENT_TASK;
			...
			extern typed_lazy_func_t<void(Player player, float x, float y, float z)> SET_PLAYER_WANTED_CENTRE_POSITION;
		...
		namespace CAM {
			...
			extern typed_lazy_func_t<int(Cam cam)> GET_CAM_SPLINE_NODE_INDEX;
			...
			extern typed_lazy_func_t<void(Cam camera, float x, float y, float z, float xRot, float yRot, float zRot, int length, int p8, int transitionType)> ADD_CAM_SPLINE_NODE;
		...
		namespace WORLDPROBE {
			...
			extern typed_lazy_func_t<void(Hash entityHit)> _SHAPE_TEST_RESULT_ENTITY;
		} /* WORLDPROBE */
		namespace UNK2 {
		...
		namespace ENTITY {
			...
			extern typed_lazy_func_t<void(Entity entity, bool p1, Hash relationshipHash)> SET_ENTITY_ONLY_DAMAGED_BY_RELATIONSHIP_GROUP;
			...
			extern typed_lazy_func_t<void(Entity entity, bool bulletProof, bool fireProof, bool explosionProof, bool collisionProof, bool meleeProof, bool p6, bool p7, bool p8)> SET_ENTITY_PROOFS;
			...
			extern typed_lazy_func_t<bool(Entity entity, bool p2)> DOES_ENTITY_BELONG_TO_THIS_SCRIPT;
			...
			extern typed_lazy_func_t<void(Entity entity1, Entity entity2, int boneIndex1, int boneIndex2, float xPos1, float yPos1, float zPos1, float xPos2, float yPos2, float zPos2, float xRot, float yRot, float zRot, float breakForce, bool fixedRot, bool p15, bool collision, bool teleport, int p18)> ATTACH_ENTITY_TO_ENTITY_PHYSICALLY;
			...
			extern typed_lazy_func_t<void(Entity entity, int alphaLevel, int skin)> SET_ENTITY_ALPHA;
		...
		namespace AUDIO {
			...
			extern typed_lazy_func_t<void(int pedIndex, Ped ped, const char* name)> ADD_PED_TO_CONVERSATION;
		...
		namespace GRAPHICS {
			...
			extern typed_lazy_func_t<void(const char* value)> _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING;
			...
			extern typed_lazy_func_t<void(bool value)> _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL;
			...
			extern typed_lazy_func_t<void(float value)> _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT;
			...
			extern typed_lazy_func_t<void(int value)> _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_INT;
			...
			extern typed_lazy_func_t<void(const char* button)> _PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME;
