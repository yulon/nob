...
rua::generic_ptr *_dxgi_swap_chain_vtab() {
	static rua::dylib d3d11("d3d11.dll");
	assert(d3d11);
	...
	sc_dsc.Windowed =
		((GetWindowLongPtr(hWnd, GWL_STYLE) & WS_POPUP) != 0) ? false : true;
	...
	if (FAILED(d3d11.RUA_DYFN(D3D11CreateDeviceAndSwapChain)(
			nullptr,
