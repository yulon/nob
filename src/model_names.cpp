//This datas from ScriptHookV/NativeTrainer

#include <nob.hpp>

namespace nob {
	constexpr const std::array<const char *, 696> model::characters {{
	...
	constexpr const std::array<const char *, 696> model::characters_desc {{
	...
	constexpr const std::array<const char *, 400> model::vehicles {{
